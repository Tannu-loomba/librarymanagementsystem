...
<body style="background:#B1D4E0;">
	<div class="container" >
		...
		<h1 class="display-4 p-3 fs-3"> 
			...
			<img src="book-image.png" width="80" style="border-radius: 50%;">
			</a>
		...
		<div class="d-flex pt-3">
			...
			<div class="pdf-list d-flex flex-wrap">
				...
				<div style="color: white; background: #1e3551; padding:  20px;  box-shadow: 0 10px 15px rgba(0, 0, 0, 0.); " class="card m-1">
					<img style="width: 10vw;" src="uploads/cover/<?=$book['cover']?>"
					     class="card-img-top">
					<div class="card-body">
						<h5 class="card-title">
							<?=$book['title']?>
